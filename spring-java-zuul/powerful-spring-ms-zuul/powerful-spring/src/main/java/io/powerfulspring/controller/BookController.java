...
import io.powerfulspring.dto.Book;
import io.powerfulspring.utils.ErrorUtils;
...
import io.powerfulspring.feign.BookFeignClient;
...
public class BookController {
	...
	public String bookListFallback(Model model, Pageable pageable) {
		model.addAttribute("message", "Remote Service not available, Please contact administrator.");
		return "/book/error";
	}
